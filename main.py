...
def run_pipeline():
    if os.environ.get("CIRCLECI", False):
        ...
        datasets = [
            ...
            SyntheticDataGenerator.variance_1_missing(0.1, use_zero=False),
            SyntheticDataGenerator.variance_1_missing(0.3, use_zero=False),
            SyntheticDataGenerator.variance_1_missing(0.5, use_zero=False),
            SyntheticDataGenerator.variance_1_missing(0.8, use_zero=False),
